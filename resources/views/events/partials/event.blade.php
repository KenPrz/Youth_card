<x-app-layout>
    ...
    <x-modal
        :maxWidth="'sm'"
        id="delete-event" name="delete-event" :show="$errors->deleteEvent->isNotEmpty()" focusable x-on:close-modal="closeModal">
        <form method="post" action="{{route('event.destroy', $event->id)}}">
            ...
            <div class="container flex flex-col">
                ...
                <div class="flex item-center justify-center my-4">
                    ...
                    <x-primary-button 
                        x-on:click.prevent="$dispatch('close-modal', 'delete-event')">
