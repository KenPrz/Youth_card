    ...
    <div class="container flex w-full items-center">
        <div class="flex-1 pe-2">
            <div class="mb-6">
                ...
                <textarea name="event_description" id="event_description" cols="30" rows="5"
        ...
        <div class="flex-1 ps-2">
            <div class="mb-3">
                ...
                <x-text-input id="vent_date" class="block mt-1 w-full" type="date"
                    name="event_date" :value="old('event_date')" required autofocus />
                @error('event_date')
                    <div class="text-red-500 mt-2 text-sm">
                        {{ $message }}
                    </div>
